...
EncryptedResourceSelector::EncryptedResourceSelector(QQmlEngine *engine, const QString &decryptionKey, QObject *parent)
    : QObject(parent)
    , m_engine(engine)
...
void EncryptedResourceSelector::registerEncryptedResource(const QString &virtualPath, const QByteArray &encryptedData)
{
    m_encryptedResources.insert(virtualPath, encryptedData);
}

QByteArray EncryptedResourceSelector::getDecryptedResource(const QString &path)
{
